...
(function() {
  try {
    if (window.supabase && typeof window.supabase.createClient === 'function') {
      ...
      console.log('KisanSetu: Supabase client ready.');
    } else {
      console.error('KisanSetu: Supabase SDK not loaded.');
    }
  } catch (err) {
    console.error('KisanSetu: Error initializing Supabase client:', err);
  }
})();
