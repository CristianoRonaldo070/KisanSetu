...
(function() {
  const TRANSLATIONS = {
    en: {
      ...
      "head_procurement_title": "Mandi Procurement & Queue",
      "head_procurement_sub": "Book slots at APMC mandis, track your queue position & MSP payments.",
      "proc_section_centers": "📍 Procurement Centers",
      "proc_section_book": "📝 Book a Slot",
      "proc_section_active": "🎫 Your Active Booking",
      "proc_section_completed": "✅ Completed Procurements",
      "proc_center": "Select Center",
      "proc_date": "Date",
      "proc_slot": "Time Slot",
      "proc_crop": "Crop",
      "proc_qty": "Quantity (Quintals)",
      "proc_vehicle": "Vehicle Number (Optional)",
      "proc_msp_rate": "MSP Rate",
      "proc_estimated_payout": "Est. Payout",
      "proc_book_btn": "🏛️ Book Slot",
      "proc_cancel_btn": "Cancel Booking",
      "proc_fast_forward": "⏩ Fast Forward (Demo)",
      "proc_token": "Your Token",
      "proc_serving": "Currently Serving",
      "proc_ahead": "Farmers Ahead",
      "proc_wait": "Est. Wait Time",
      "proc_minutes": "min",
      "proc_status_confirmed": "Slot Confirmed",
      "proc_status_gate": "Gate Entry",
      "proc_status_weighbridge": "Weighbridge & Inspection",
      "proc_status_complete": "Procurement Complete",
      "proc_status_payment": "DBT Payment Released",
      "proc_no_active": "No active bookings. Book a slot above to get started!",
      "proc_no_completed": "No completed procurements yet.",
      "proc_quality": "Quality Grade",
      "proc_net_weight": "Net Weighed",
      "proc_total_payout": "Total Payout",
      "proc_dbt_status": "DBT Status",
      "proc_dbt_credited": "✅ Credited via PFMS to Bank A/C ****4129",
      "proc_dbt_pending": "⏳ Payment Processing via PFMS",
      "proc_txn_ref": "Txn Ref",
      "proc_bay": "Weighbridge Bay",
      "proc_open_hours": "Operating Hours",
      "proc_bays_active": "Active Bays",
      "proc_crops_accepted": "Crops Accepted",
      "proc_today": "Today",
      "proc_tomorrow": "Tomorrow",
      "proc_booked_success": "Slot booked successfully! 🎉 Your token: ",
    ...
    hi: {
      ...
      "tab_procurement": "अधिप्राप्ती",
      "head_procurement_title": "मंडी अधिप्राप्ती और कतार",
      "head_procurement_sub": "APMC मंडी में स्लॉट बुक करें, कतार स्थिति और MSP भुगतान ट्रैक करें।",
      "proc_section_centers": "📍 अधिप्राप्ती केंद्र",
      "proc_section_book": "📝 स्लॉट बुक करें",
      "proc_section_active": "🎫 आपकी सक्रिय बुकिंग",
      "proc_section_completed": "✅ पूर्ण अधिप्राप्ती",
      "proc_center": "केंद्र चुनें",
      "proc_date": "दिनांक",
      "proc_slot": "समय स्लॉट",
      "proc_crop": "फसल",
      "proc_qty": "मात्रा (क्विंटल)",
      "proc_vehicle": "वाहन नंबर (वैकल्पिक)",
      "proc_msp_rate": "MSP दर",
      "proc_estimated_payout": "अनु. भुगतान",
      "proc_book_btn": "🏛️ स्लॉट बुक करें",
      "proc_cancel_btn": "बुकिंग रद्द करें",
      "proc_fast_forward": "⏩ तेज़ आगे (डेमो)",
      "proc_token": "आपका टोकन",
      "proc_serving": "वर्तमान सेवा",
      "proc_ahead": "आगे किसान",
      "proc_wait": "अनु. प्रतीक्षा",
      "proc_minutes": "मि.",
      "proc_status_confirmed": "स्लॉट पुष्टि",
      "proc_status_gate": "गेट प्रवेश",
      "proc_status_weighbridge": "तुलाई और निरीक्षण",
      "proc_status_complete": "अधिप्राप्ती पूर्ण",
      "proc_status_payment": "DBT भुगतान जारी",
      "proc_no_active": "कोई सक्रिय बुकिंग नहीं। ऊपर स्लॉट बुक करें!",
      "proc_no_completed": "अभी तक कोई पूर्ण अधिप्राप्ती नहीं।",
      "proc_quality": "गुणवत्ता ग्रेड",
      "proc_net_weight": "शुद्ध वजन",
      "proc_total_payout": "कुल भुगतान",
      "proc_dbt_status": "DBT स्थिति",
      "proc_dbt_credited": "✅ PFMS द्वारा बैंक खाते ****4129 में जमा",
      "proc_dbt_pending": "⏳ PFMS द्वारा भुगतान प्रक्रिया",
      "proc_txn_ref": "लेन-देन संदर्भ",
      "proc_bay": "तुलाई बे",
      "proc_open_hours": "संचालन समय",
      "proc_bays_active": "सक्रिय बे",
      "proc_crops_accepted": "स्वीकृत फसलें",
      "proc_today": "आज",
      "proc_tomorrow": "कल",
      "proc_booked_success": "स्लॉट सफलतापूर्वक बुक हो गया! 🎉 आपका टोकन: ",
    ...
    mr: {
      ...
      "tab_procurement": "अधिप्राप्ती",
      "head_procurement_title": "मंडी अधिप्राप्ती व रांग",
      "head_procurement_sub": "APMC मंडीत स्लॉट बुक करा, रांगेतील स्थान आणि MSP देयके ट्रॅक करा.",
      "proc_section_centers": "📍 अधिप्राप्ती केंद्रे",
      "proc_section_book": "📝 स्लॉट बुक करा",
      "proc_section_active": "🎫 तुमची सक्रिय बुकिंग",
      "proc_section_completed": "✅ पूर्ण अधिप्राप्ती",
      "proc_center": "केंद्र निवडा",
      "proc_date": "तारीख",
      "proc_slot": "वेळ स्लॉट",
      "proc_crop": "पीक",
      "proc_qty": "प्रमाण (क्विंटल)",
      "proc_vehicle": "वाहन क्रमांक (ऐच्छिक)",
      "proc_msp_rate": "MSP दर",
      "proc_estimated_payout": "अंदाजे देय",
      "proc_book_btn": "🏛️ स्लॉट बुक करा",
      "proc_cancel_btn": "बुकिंग रद्द करा",
      "proc_fast_forward": "⏩ पुढे जा (डेमो)",
      "proc_token": "तुमचा टोकन",
      "proc_serving": "सध्या सेवा",
      "proc_ahead": "पुढे शेतकरी",
      "proc_wait": "अंदाजे प्रतीक्षा",
      "proc_minutes": "मि.",
      "proc_status_confirmed": "स्लॉट पुष्टी",
      "proc_status_gate": "गेट प्रवेश",
      "proc_status_weighbridge": "वजनकाटा व तपासणी",
      "proc_status_complete": "अधिप्राप्ती पूर्ण",
      "proc_status_payment": "DBT पेमेंट जारी",
      "proc_no_active": "सक्रिय बुकिंग नाही. वरील स्लॉट बुक करा!",
      "proc_no_completed": "अद्याप कोणतीही पूर्ण अधिप्राप्ती नाही.",
      "proc_quality": "गुणवत्ता श्रेणी",
      "proc_net_weight": "निव्वळ वजन",
      "proc_total_payout": "एकूण देय",
      "proc_dbt_status": "DBT स्थिती",
      "proc_dbt_credited": "✅ PFMS द्वारे बँक खाते ****4129 मध्ये जमा",
      "proc_dbt_pending": "⏳ PFMS द्वारे पेमेंट प्रक्रिया",
      "proc_txn_ref": "व्यवहार संदर्भ",
      "proc_bay": "वजनकाटा बे",
      "proc_open_hours": "कार्य वेळ",
      "proc_bays_active": "सक्रिय बे",
      "proc_crops_accepted": "स्वीकृत पिके",
      "proc_today": "आज",
      "proc_tomorrow": "उद्या",
      "proc_booked_success": "स्लॉट यशस्वीरीत्या बुक झाला! 🎉 तुमचा टोकन: ",
